...
public class SMA5PKU extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            {
                String website = "https://idalamat.com/alamat/247822/sma-negeri-5-pekanbaru-pekanbaru-riau";
            ...
            } else if (pilihan.equals("Info di Google"))
            {
                ...
                a.putExtra(SearchManager.QUERY, "SMA 5 Pekanbaru");
